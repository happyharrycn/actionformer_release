...
## Changelog
* 7/4/2023: We have released the code for our submission to the [Ego4D Moment Queries (MQ) Challenge 2023](https://eval.ai/web/challenges/challenge-page/1626/overview). The code repo now includes config files and features.
* 11/18/2022: We have released the [tech report](https://arxiv.org/abs/2211.09074) for our submission to the [Ego4D Moment Queries (MQ) Challenge 2022](https://eval.ai/web/challenges/challenge-page/1626/overview). The code repo now includes config files, pre-trained models and results on the Ego4D MQ benchmark.
...
**Download Features and Annotations**
* For Ego4D Moment Queries Challenge 2023, we added InternVideo features, the features can be downloaded from [this link](https://drive.google.com/file/d/1EcSutCyUj1_B6MXPe8xjJbBPidDxCSo8/view?usp=sharing). 
...
│    └───ego4d/
│    │   └───annotations
│    │   └───slowfast_features (for Ego4D Moment Queries 2022)
│    │   └───omnivore_features
│    │   └───egovlp_features  
│    │   └───internvideo_features (for Ego4D Moment Queries 2023)
│    └───...
|
└───libs
│
